...
def _mbb_payload(
    ...
    return {
        ...
        "esim": {"iccid": "", "isp_aid": "", "last_operation": {"code": 0, "state": "SUCCESS", "type": "UNKNOWN"}},
        "imei": str(_network_cfg(data, "IMEI") or ""),
        "ip_settings": {
            "ipv4_address": ip_address,
            "ipv4_gateway": gateway,
            "ipv4_netmask": netmask,
            "ipv4-primary-dns": gateway,
            "ipv4-secondary-dns": DEFAULT_DNS,
        },
        "radio": {
            "band": radio["band"],
        ...
        "sim": [
            {
                ...
                "esim": False,
                "gid1": "",
                "iccid": str(_sim_cfg(data, "ICCID") or ""),
